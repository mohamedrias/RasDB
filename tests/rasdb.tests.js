...
*/
	...
	assert(Students.sort("id").first().get()[0]===data[1], "Sort array using a given property");
	assert(Students.sort("-id").first().get()[0]===data[data.length-1], "Sort array using a given property in reverse");
})();