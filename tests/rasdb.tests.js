...
(function() {
	...
	console.log(data[0]);
	assert(Students.findById(0).get(0)===data[0], "Both the wrapped object and original object are same");
	(function() {
		var originalObject = data[0];
